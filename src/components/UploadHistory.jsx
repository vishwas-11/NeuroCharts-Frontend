...
//                   {/* NEW: Display uploader info for admin/superadmin */}
//                   {(user.role === 'admin' || user.role === 'superadmin') && (
//                     <span className="text-xs text-purple-400 mt-1 block">Uploaded by: {item.userId}</span>
//                   )}
//                 </div>
...
//                   {/* The remove button only shows for the user who uploaded the file */}
//                   {user.id === item.userId && (
//                     <button
